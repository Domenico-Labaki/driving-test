...
module tb_vehicle_controller;
    ...
    initial begin
        ...
        #100 rst = 0;
        #40;
        $display("Start pos x=%0d y=%0d dir=%0d (expect 60,60,1)",
        ...
        $display("Direction after steer at speed=0: %0d (expect unchanged=1)", direction);
        steer_right = 0;
        ...
        repeat (5) @(posedge clk_game);
        $display("Direction after steer right at speed>0: %0d (expect 2=DOWN)", direction);
